...
\section{Achievements}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {India Innovation Challenge Design Contest (IICDC) - 2018}{India}
      {www.mygov.in}{Jun, 2018 - Aug, 2019}
      \resumeItemListStart
        \resumeItem{Outcome}
          {Made it to Quarter Finals and Proposed idea got approved. The idea is in incubation phase and will be proceeded further.}
        \resumeItem{Highlights}
          {Organized and sponsored by Texas Instruments (TI) in collaboration with Department of Science and Technology (DST), India. Here, we provided an idea for a real-world problem with the objective of practical implementation on basis of business potential and technical innovation.}
      \resumeItemListEnd

    \resumeSubheading
      {National Convention on Quality Control Circle}{Madurai, India}
      {Participant for Case-study}{July, 2010 - Mar, 2011}
      \resumeItemListStart
        \resumeItem{Outcome}
...
\section{Technical Skills}
  \resumeSubHeadingListStart
    \item{\textbf{Languages}{: C/C++, Python, JavaScript, Latex, Verilog/VHDL}}
      \hfill
      \item{\textbf{Technologies}{: OpenCV, ROS, MATLAB, OrCAD, Perception \& Control, Git/ Github, Linux}}
  \resumeSubHeadingListEnd
%------------------------------------  
