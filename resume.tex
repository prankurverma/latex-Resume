...
\section{Achievements}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Outcome}
          {Stood 4th (amongst 202 teams with 4 members each) in the finals of the National Robotics Competition}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Outcome}
          {: Stood 3rd in the Case study and presentation of assessment done in school.}
        \resumeItem{Nostos}
