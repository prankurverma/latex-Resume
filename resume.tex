...
\section{Education}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Intermediate 10+2 CBSE;  CGPA: 9.0/10.0}{2013 -- 2014}
    \resumeSubheading
      {Dayawati Modi Academy}{Meerut, UP, India}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{About}
          {Conducted by IIT Bombay, sponsored by \textbf{MHRD} through NMEICT. The finals was held at IIT-Bombay in which over 200+ teams participated in a total of 4 themes}
      \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{About}{The main objective of the event is to do a thorough study of the problems faced by students at school-level.Several key elements used were Pareto-analysis, 6-sigma method Brainstorming, Questionaires.Finally we give a detailed presentation at event venue in Madurai, Tamil Nadu where several renowned persons were there like: Mr. Anand Kumar (Super30 programme founder), etc.}
      \resumeItemListEnd
...
\section{Technical Skills}
  \resumeSubHeadingListStart
    \item{
      \textbf{Languages}{: C/C++, Python, Javascript, Latex, Verilog/VHDL}
      \hfill
      \item{\textbf{Technologies}{: ROS, MATLAB, OpenCV, AWS, GCP}}
    }
  \resumeSubHeadingListEnd
...
\section{Certification}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {National E-yantra Robotics Competition}{Aug, 2017 - Mar, 2018}
      \resumeItemListStart
        \resumeItem{Tensorflow}
          {TensorFlow is an open source software library for numerical computation using data flow graphs; primarily used for training deep learning models.}
        \resumeItem{Apache Beam}
